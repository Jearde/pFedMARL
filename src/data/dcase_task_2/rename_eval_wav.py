...
# labeled data path
EVAL_DATA_LIST_PATH = {
    "DCASE2020T2": f"{ROOT_DIR}/meta/eval_data_list_2020.csv",
    "DCASE2021T2": f"{ROOT_DIR}/meta/eval_data_list_2021.csv",
    "DCASE2022T2": f"{ROOT_DIR}/meta/eval_data_list_2022.csv",
    "DCASE2023T2": f"{ROOT_DIR}/meta/eval_data_list_2023.csv",
    "DCASE2024T2": f"{ROOT_DIR}/meta/eval_data_list_2024.csv",
}
...
def copy_wav(dataset_parent_dir, dataset_type):
    dataset_dir = ROOT_DIR / dataset_parent_dir / "raw"
    ...
    if os.path.exists(eval_data_list_path):
        ...
        raise FileNotFoundError(
            f"Err:eval_data_list.csv not found : {eval_data_list_path}"
        )
    ...
    for eval_data in eval_data_list:
        if len(eval_data) < CHK_MACHINE_TYPE_LINE:
            ...
            default_dir = dataset_dir / machine_type / "test"
            save_dir = dataset_dir / machine_type / "test_rename"
